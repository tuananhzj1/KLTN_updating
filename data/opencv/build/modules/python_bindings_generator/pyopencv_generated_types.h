...
CVPY_TYPE(hdf_HDF5, hdf_HDF5, Ptr<cv::hdf::HDF5>, Ptr, NoBase, 0);
...
CVPY_TYPE(ximgproc_ScanSegment, ximgproc_ScanSegment, Ptr<cv::ximgproc::ScanSegment>, Ptr, Algorithm, 0);
